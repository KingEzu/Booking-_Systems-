...
const AddShows = () => {
  ...
  const [selectedMovie, setSelectedMovie] = useState(null); // ✅ fixed SetSelectedMovie naming
    ...
    <>
      ...
      <div className="mt-8">
        ...
        <div className="inline-flex items-center gap-2 border broder-gray-600 px-4 py-2 rounded-md ">
            ...
            <input min={0} type='number' value={showPrice} onChange={(e)=> setShowPrice(e.target.value)} placeholder='enter the show price' className='outline-none'/>
        </div>
      </div>
      ...
      <div className="mt-6">
        ...
        <div className="inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg">
            <input type="datetime-local" value={dateTimeInput}    onChange={handleDateTimeChange}
