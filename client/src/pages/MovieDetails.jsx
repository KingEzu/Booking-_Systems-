...
const MovieDetails = () => {
  ...
  if (!show) {
    return <div className="text-center text-gray-300 mt-20 text-lg">Loading...</div>;
  }
...
<div className="flex justify-between items-center">
  ...
  <p className="text-primary-dull bg-primary uppercase border-1 py-1 px-5 border-amber-50/50 rounded ">{movie.playGround}</p>
          ...
          <div className="flex items-center flex-wrap gap-4 mt-4">
            ...
            <a href='#dateSelect' className='px-10 py-3 text-sm bg-primary-dull/85 text-black/95 hover:bg-primary hover:text-amber-50  transition rounded-md font-medium cursor-pointer active:scale-95'>Buy Tickets</a>
